...
import com.example.composepractice.screen.drawer.navigation.DrawerNavHost
...
fun DrawerScreen() {
    ...
    ModalNavigationDrawer(
            ...
            AppDrawerContent(
                ...
                when (onUserPickedOption) {
                    MainNavOption.HomeScreen -> {
                        navController.navigate(DrawerNavigation.DrawerScreen.route)
                    }

                    MainNavOption.SettingsScreen -> {
                        navController.navigate(DrawerNavigation.SettingsScreen.route)
                    }

                    MainNavOption.AboutScreen -> {
                        navController.navigate(DrawerNavigation.AboutScreen.route)
                    }
                }
            }
        }
        ...
        // NavHost...
        DrawerNavHost(navController = navController, drawerState = drawerState)
    }
}
